...
# Filter data based on team selection before populating player list
filtered_df = df[df['Minutes played'] >= 500]
if selected_team != "All":
    filtered_df = filtered_df[filtered_df['Team within selected timeframe'] == selected_team]
